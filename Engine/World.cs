...
namespace Engine
{
    public static class World
    {
        ...
        public const int LOCATION_ID_TOWM_SQUARE = 2;
        ...
        private static void PopulateLocations()
        {
            ...
            Location townSquare = new Location(LOCATION_ID_TOWM_SQUARE, "Town square", "you see a fountain.");

            Location alchemistHut = new Location(LOCATION_ID_ALCHEMIST_HUT, "Alchemist's hut", "There are many strange plants on the shelves.");
            alchemistHut.QuestAvailableHere = QuestByID(QUEST_ID_CLEAR_ALCHEMIST_GARDEN);

            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN, "Alchemist's garden", "Many plants are grown here.");
            ...
            alchemistsGarden.LocationToSouth = townSquare;
